...
class InputSection {
    constructor(element) {
        ...
        let gif1 = new WizardGIFExample('assets/tm_v1/wizard/1.gif');
        if (GLOBALS.browserUtils.isMobile) {
        ...
        let gif2 = new WizardGIFExample('assets/tm_v1/wizard/2.gif');
        if (GLOBALS.browserUtils.isMobile) {
        ...
        let gif3 = new WizardGIFExample('assets/tm_v1/wizard/3.gif');
        if (GLOBALS.browserUtils.isMobile) {
        ...
        let gif4 = new WizardGIFExample('assets/tm_v1/wizard/4.gif');
        if (GLOBALS.browserUtils.isMobile) {
